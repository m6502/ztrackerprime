    ...
    if (need_refresh) {
        ...
        if (clear_popup) {
            ...
            if (S->lock()==0) {
                ...
                // <Manu> Creo que este clean es mejorable y seg�n c�mo redundante
...
//    int ret = Mix_OpenAudio(wanted.freq, MIX_DEFAULT_FORMAT, MIX_DEFAULT_CHANNELS, wanted.samples);
    ...
    // <Manu> Hay un problema de orden de cosas aqu�, de momento hacemos un peque�o parche pero habr� que mirar c�mo hacerlo bien
